...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 7049005;

  static const kDefaultExternalLibraryLoaderConfig =
      ExternalLibraryLoaderConfig(
    stem: 'auth0_flutter_plugin',
  ...
  Future<Uint8List> crateApiFfiWebAuthenticationLogout(
    ...
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        ...
        sse_encode_opt_String(returnTo, serializer);
        pdeCallFfi(generalizedFrbRustBinding, serializer,
            funcId: 2, port: port_);
      },
      codec: SseCodec(
      ...
      constMeta: kCrateApiFfiWebAuthenticationLogoutConstMeta,
      argValues: [domain, clientId, returnTo],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiFfiWebAuthenticationLogoutConstMeta =>
      const TaskConstMeta(
        debugName: "web_authentication_logout",
        argNames: ["domain", "clientId", "returnTo"],
      );
